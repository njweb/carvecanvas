...
var carve = function carve(canvasContext, projectCoordinate, configuration) {

  var builtInstructions = (0, _instructions.instructions)(canvasContext, projectCoordinate);
  var operations = [];
